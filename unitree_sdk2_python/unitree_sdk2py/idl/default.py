...
# 传入的参数分别对应mode q dq tau kp kd reserve
...
# [unitree_hg_msg_dds__MotorCmd_() for i in range(35) 创建35个motor对象
'''
HGLowCmd_ 传入的5个参数 北依次赋值给unitree_sdk2py/idl/unitree_hg/msg/dds_/_LowCmd_.py 的mode_pr，mode_machine，motor_cmd，reserve，crc
'''
def unitree_hg_msg_dds__LowCmd_():
    return HGLowCmd_(0, 0, [unitree_hg_msg_dds__MotorCmd_() for i in range(35)], [0, 0, 0, 0], 0)

'''
HGLowState_ 分别传给unitree_sdk2py/idl/unitree_hg/msg/dds_/_LowState_.py 的version mode_pr mode_machine tick imu_state motor_state wireless_remote reserve crc
'''
