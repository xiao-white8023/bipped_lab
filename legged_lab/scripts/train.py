...
from rsl_rl.runners import AmpOnPolicyRunner, OnPolicyRunner, MoeAmpOnPolicyRunner, DWAQAmpOnPolicyRunner, MoeOnPolicyRunner,G1OnPolicyRunner,FilmOnPolicyRunner, RENetAmpOnPolicyRunner
...
def train():
    ...
    runner_class: FilmOnPolicyRunner|OnPolicyRunner | AmpOnPolicyRunner | RENetAmpOnPolicyRunner | MoeAmpOnPolicyRunner | DWAQAmpOnPolicyRunner | MoeOnPolicyRunner|G1OnPolicyRunner|G1StudentOnPolicyRunner = eval(agent_cfg.runner_class_name)
