...
class G1MOEROUGHEnv(VecEnv):
    ...
    def compute_current_observations(self):
        ...
        current_critic_obs = torch.cat([current_actor_obs,  feet_contact,root_lin_vel * self.obs_scales.lin_vel], dim=-1)
    ...
    def get_processed_deepcamera(self):
        ...
        if self.cfg.scene.camera.add_camera_noise:
            ...
            # 必须接收返回值，因为 tensor 在底层被替换了
                depth_cropped = self.add_camera_noise(depth_cropped, env_ids)
