...
class CameraDomainRandCfg:
    ...
    rpy_range: tuple[tuple[float, float], tuple[float, float], tuple[float, float]] = (
...
class CustomRslRlPpoActorCriticCfg(RslRlPpoActorCriticCfg):
    ...
    mha_num_heads:int = 16
    mha_conv_hidden_channels:int = 16
    mha_kernel_size:int = 5
    point_feature_dim:int = 3

@configclass
class CustomAmpPpoAlgorithmCfg(RslRlPpoAlgorithmCfg):
...
class AttenAGENTENV:
    ...
    algorithm = CustomAmpPpoAlgorithmCfg(
